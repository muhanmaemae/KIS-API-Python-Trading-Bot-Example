🚀 KIS-API-Python-Trading-Bot-Example (V24.16 2대 코어 초경량 에디션)   
...
💎 V-REV 역추세 하이브리드 엔진 : 0주 새출발 시 상승장 소외(FOMO)를 막는 1층(1.15배 할증)과 단기 휩소 하락을 노리는 2층(0.975배 하향)으로 매수 타점을 50%씩 디커플링합니다. 장 마감 30분 전 독자적인 1분 단위 타임 슬라이싱 매매를 자율 가동합니다.   
...
📁 telegram_bot.py / telegram_view.py : 레거시 UI를 완벽히 적출한 초경량 텔레그램 봇 컨트롤러 및 통합 지시서 렌더링 로직.   
